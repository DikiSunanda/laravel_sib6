...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-7 col-lg-4 mb-5 mb-lg-0 wow fadeIn">
            ...
            @empty($p->poto)
        <img src="{{url('admin/image/No-Photo.png')}}" alt="project-image" class="rounded">
        @else
        <img src="{{url('admin/image')}}/{{$p->poto}}" alt="project-image" class="rounded">
        @endempty
                <div class="card-body p-1-9 p-xl-5">
                    ...
                    <ul class="list-unstyled mb-4">
                        <li class="mb-3"><a href="#!"><i class="far fa-envelope display-25 me-3 text-secondary"></i>{{$pelanggan->email}}</a></li>
